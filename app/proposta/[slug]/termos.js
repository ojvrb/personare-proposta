...
export function textoTermos({ nomeCliente, valorTotal, dataEvento, numConvidados, atendente }) {
  ...
  return [
    { titulo: "O que você está aceitando agora", corpo: `Ao confirmar, você aceita a PROPOSTA apresentada — o pacote, o buffet, os extras e o valor total de ${valor} para o evento ${evento} com ${numConvidados || "número a confirmar"} convidados. Isso reserva sua data e trava esses valores nas condições descritas.` },
